<?php $__env->startSection('title', 'Login - Karya Jaya Las Konstruksi'); ?>
    ...
    <div class="auth-card">
        ...
        <div class="auth-left">
            ...
            <div class="footer-text">
                © <?php echo e(date('Y')); ?> Karya Jaya Las Konstruksi. All rights reserved.
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\karya-jaya-las\resources\views/auth/login.blade.php ENDPATH**/ ?>