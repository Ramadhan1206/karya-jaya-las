...
<?php $__env->startSection('title', 'Data Absensi - Admin'); ?>
...
<div class="container-fluid" style="position: relative; z-index: 1;">
    ...
    <div class="stat-grid">
        <div class="stat-card total animate-in">
            ...
            <div class="stat-value" data-target="<?php echo e($totalSemua ?? 0); ?>"><?php echo e($totalSemua ?? 0); ?></div>
        ...
        <div class="stat-card hadir animate-in">
            ...
            <div class="stat-value" data-target="<?php echo e($totalHadir ?? 0); ?>"><?php echo e($totalHadir ?? 0); ?></div>
            <div class="stat-label">Hadir</div>
            <span class="stat-badge"><i class="fas fa-arrow-up"></i> Aktif</span>
        </div>
        <div class="stat-card izin animate-in">
            <div class="stat-icon"><i class="fas fa-clock"></i></div>
            <div class="stat-value" data-target="<?php echo e($totalIzin ?? 0); ?>"><?php echo e($totalIzin ?? 0); ?></div>
        ...
        <div class="stat-card sakit animate-in">
            ...
            <div class="stat-value" data-target="<?php echo e($totalSakit ?? 0); ?>"><?php echo e($totalSakit ?? 0); ?></div>
            <div class="stat-label">Sakit</div>
            <span class="stat-badge"><i class="fas fa-arrow-down"></i> Menurun</span>
        </div>
        <div class="stat-card alpha animate-in">
            <div class="stat-icon"><i class="fas fa-times-circle"></i></div>
            <div class="stat-value" data-target="<?php echo e($totalAlpha ?? 0); ?>"><?php echo e($totalAlpha ?? 0); ?></div>
    ...
    <div class="filter-card animate-in">
        <div class="filter-header">
            ...
            <?php if(request()->hasAny(['user_id', 'status', 'tanggal'])): ?>
                <a href="<?php echo e(route('admin.absen')); ?>" class="reset-btn">
                    <i class="fas fa-times"></i> Reset Filter
                </a>
            <?php endif; ?>
        </div>
        <form method="GET" action="<?php echo e(route('admin.absen')); ?>" class="row g-3 align-items-end">
            <div class="col-md-3">
    ...
    <div class="table-card animate-in">
        <div class="card-header">
            ...
            <span class="count-badge">
                ...
                <?php echo e($absensi->total() ?? 0); ?> Data
            </span>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $absensi ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr class="animate-in" style="animation-delay: <?php echo e($loop->index * 0.03); ?>s;">
                            <td>
                                <div class="user-cell">
                                    ...
                                    <div class="info">
                                        <span class="name"><?php echo e($item->nama_lengkap ?? $item->user->name ?? 'User'); ?></span>
                                        <span class="email"><?php echo e($item->user->email ?? '-'); ?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="date-cell">
                                    <span class="date-main"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d M Y')); ?></span>
                                    <span class="date-day"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('l')); ?></span>
                                </div>
                            </td>
                            <td>
                                <?php if($item->jam_masuk): ?>
                                    <span class="time-cell in">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($item->jam_masuk)->format('H:i')); ?>
                            ...
                            <td>
                                <?php if($item->jam_pulang): ?>
                                    <span class="time-cell out">
                                        <span class="time-dot"></span>
                                        <?php echo e(\Carbon\Carbon::parse($item->jam_pulang)->format('H:i')); ?>
                            ...
                            <td>
                                <span class="status-badge-premium <?php echo e($item->status); ?>">
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.absen.detail', $item->id)); ?>" class="btn-detail-premium">
        ...
        <!-- ===== PAGINATION ===== -->
        <?php if(($absensi ?? null) && $absensi->hasPages()): ?>
            <div class="pagination-wrap">
                <div class="info">
                    Menampilkan <strong><?php echo e($absensi->firstItem() ?? 0); ?></strong> -
                    <strong><?php echo e($absensi->lastItem() ?? 0); ?></strong> dari
                    <strong><?php echo e($absensi->total()); ?></strong> data
                </div>
                <div>
                    <?php echo e($absensi->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\karya-jaya-las\resources\views/admin/absen/index.blade.php ENDPATH**/ ?>