...
<?php $__env->startSection('title', 'Data Gajian - Admin'); ?>
...
<div class="container-fluid">
    ...
    <div class="stat-grid-keren">
        <div class="stat-keren purple fade-up-keren">
            ...
            <div class="stat-number purple">
                <span class="currency">Rp</span> <?php echo e(number_format($totalGaji ?? 0, 0, ',', '.')); ?>
        ...
        <div class="stat-keren green fade-up-keren">
            ...
            <div class="stat-number green"><?php echo e($totalDibayar ?? 0); ?></div>
        ...
        <div class="stat-keren yellow fade-up-keren">
            ...
            <div class="stat-number yellow"><?php echo e($totalProses ?? 0); ?></div>
        ...
        <div class="stat-keren red fade-up-keren">
            ...
            <div class="stat-number red"><?php echo e($totalBatal ?? 0); ?></div>
    ...
    <div class="status-mini-grid-keren">
        <div class="status-mini-keren green fade-up-keren">
            ...
            <div class="right">
                <div class="count"><?php echo e($totalDibayar ?? 0); ?></div>
        ...
        <div class="status-mini-keren yellow fade-up-keren">
            ...
            <div class="right">
                <div class="count"><?php echo e($totalProses ?? 0); ?></div>
        ...
        <div class="status-mini-keren red fade-up-keren">
            ...
            <div class="right">
                <div class="count"><?php echo e($totalBatal ?? 0); ?></div>
    ...
    <div class="filter-keren fade-up-keren">
        <form method="GET" action="<?php echo e(route('admin.gajian')); ?>" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.gajian')); ?>" class="btn-reset-keren">
    ...
    <div class="table-keren fade-up-keren">
        <div class="header">
            ...
            <span class="count-badge">
                ...
                <?php echo e($gajian->total() ?? 0); ?> Data
            </span>
        </div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $gajian ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="slide-in-keren" style="animation-delay: <?php echo e($loop->index * 0.03); ?>s;">
                            <td>
                            ...
                            <td>
                                <div class="user-info-keren">
                                    <div class="avatar <?php echo e($color); ?>">
                                        <?php echo e($inisial); ?>

                                    </div>
                                    <div class="info">
                                        <span class="name"><?php echo e($item->user->name ?? '-'); ?></span>
                                        <span class="email">
                            ...
                            <td>
                                <span style="font-weight: 500;">
                                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_gaji)->isoFormat('dddd, D MMMM YYYY')); ?>
                            ...
                            <td>
                                <span style="font-weight: 700; color: var(--primary); font-size: 14px;">
                                    Rp <?php echo e(number_format($item->total_gaji ?? 0, 0, ',', '.')); ?>

                                </span>
                            </td>
                            <td>
                                <span class="status-badge-keren badge-<?php echo e($status); ?>">
                                    <span class="dot"></span>
                                    <?php echo e(ucfirst($status)); ?>
                            ...
                            <td style="text-align: center;">
                                <div class="action-group-keren">
                                    <!-- Detail -->
                                    <a href="<?php echo e(route('admin.gajian.detail', $item->id)); ?>" 
                                    ...
                                    <button class="btn-action-keren edit" title="Ubah Status" 
                                            ...
                                            data-bs-target="#modalStatus<?php echo e($item->id); ?>">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    
                                    <!-- Hapus -->
                                    <form action="<?php echo e(route('admin.gajian.delete', $item->id)); ?>" 
                                          method="POST" 
                                          class="d-inline"
        ...
        <!-- Pagination -->
        <?php if($gajian->hasPages()): ?>
            <div class="d-flex justify-content-center mt-3">
                <?php echo e($gajian->appends(request()->query())->links()); ?>
...
MODAL STATUS - KEREN
============================================================ -->
<?php $__currentLoopData = $gajian ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal modal-keren fade" id="modalStatus<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('admin.gajian.update-status', $item->id)); ?>" id="formStatus<?php echo e($item->id); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select" required>
                                ...
                                <option value="dibayar" <?php echo e(($item->status ?? '') == 'dibayar' ? 'selected' : ''); ?>>✅ Dibayar</option>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="keterangan" class="form-control" rows="3" 
                                      placeholder="Tambahkan keterangan (opsional)"><?php echo e($item->keterangan ?? ''); ?></textarea>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\karya-jaya-las\resources\views/admin/gajian/index.blade.php ENDPATH**/ ?>